...
public class AboutWindow extends JDialog {
	...
	private void setupWindow() {
		...
		infoLabel = new JLabel(
				"<html>Mass Effect 3 Mod Manager<br> Version "
						+ ModManager.VERSION + " Build "+ModManager.BUILD_NUMBER
						+ "- "+ModManager.BUILD_DATE+"<br>Developed by FemShep (http://me3tweaks.com)"
								+ "<br>"
								+ "Source code available at http://github.com/mgamerz/me3modmanager"
								+ "<br>"
								+ "<br>Uses 7-Zip-JBinding: http://sevenzipjbind.sourceforge.net/"
								+ "<br>Uses 7-Zip: http://7zip.org"
								...
								+ "<br>Uses FileDrop: http://iharder.sourceforge.net/current/java/filedrop/"
								+ "<br>Uses ini4j: http://ini4j.sourceforge.net"
								+ "<br>Uses json-simple: https://code.google.com/p/json-simple/"
								+ "<br>Uses jdiff/jptch: http://jojodiff.sourceforge.net/"
								+ "<br>Uses JNA: https://github.com/java-native-access/jna"
								+ "<br>ME3CMM includes LauncherWV: http://github.com/me3explorer/launcherwv"
								+ "<br>ME3CMM includes TLK and Coalesce tools from TankMaster"
								+ "<br>ME3CMM includes the binkw32.dll bypass by WarrantyVoider"
								+ "<br>ME3CMM includes the binkw32.dll ASI bypass by ErikJS"
