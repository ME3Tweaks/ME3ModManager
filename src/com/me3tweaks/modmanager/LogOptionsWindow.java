        ...
        if (ModManagerWindow.validateBIOGameDir()) {
            ...
            for (String dir : directories) {
                ...
                if (dir.toUpperCase().startsWith("DLC_")) {
                    ...
                    if (metacmm.exists()) {
                        String metaname = new MetaCMM(metacmm).getDisplayString();
